...
export const INVALID_EMAIL_MESSAGE = 'Must be valid email address';
export const EMAIL_REQUIRED_MESSAGE = 'Email field is required';
export const PASSWORD_REQUIRED_MESSAGE = 'Password field is required';
